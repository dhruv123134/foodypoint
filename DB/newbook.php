                ...
                <nav class="sidebar-nav">
                   <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="newbook.php" aria-expanded="false"><i class="fa fa-archive f-s-20 color-warning"></i><span class="hide-menu">New Delivery</span></a>
						 ...
						 <li> <a href="Complited_ord.php"><i class="fa fa-shopping-cart" aria-hidden="true"></i><span>All Completed Delivery </span></a></li>
                                    ...
                                    <thead class="thead-dark">
                                        ...
                                        <tbody>
                                         ...
                                         $Delivery_id=$_SESSION['Delivery_id'];
												...
												$sql="SELECT users.*, users_orders.* FROM users INNER JOIN users_orders ON users.u_id=users_orders.u_id WHERE Delivery_id='{$Delivery_id}' ";
                                                                      ...
                                                                      if($rows['status']!="closed"){
																		   ...
																		   <?php 
																			...
																			if($status=="closed")
																				{
																			?>
																			<td> <button type="button" class="btn btn-primary" ><span  class="fa fa-check-circle" aria-hidden="true"></span> Complited</button></td> 
																			<?php 
																			} 
																			?>
																			<?php
																			...
																			?>
																						<?php																									
																							...
																							?>
																								...
																								<?php
																								echo '<a href="status.php?user_upd='.$rows['o_id'].'" " class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="fa fa-edit"></i></a>
																									</td>
																									</tr>';
