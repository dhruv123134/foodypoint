...
<body class="home">
        ...
        <header id="header" class="header-scroll top-header headrom">
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/Logo.jpg" style="width: 44px" alt=""> </a>
        ...
        <!-- <section class="hero bg-image" data-image-src="images/img/restrrr.png"> black image vadi line -->
														...
														<div class="restaurant-wrap">
															<div class="row">
																...
																<div class="col-xs-12 col-sm-9 col-md-12 col-lg-9">
																	<h5><a href="dishes.php?res_id='.$rows['rs_id'].'" >'.$rows['title'].'</a></h5> <span style="color:#000;">'.$rows['address'].'</span>
																</div>
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                                    <h5>Address</h5>
                                    <p>gandhinagar</p>
                                    <h5>Phone: 8140243964</a></h5> 
                                    <h5>Phone: 9601546877</a></h5></div>
